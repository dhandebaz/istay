      ...
      <div class="min-h-screen bg-gray-50 py-10 px-4">
        <div class="max-w-3xl mx-auto">
          ...
          <div class="no-print flex flex-wrap justify-between items-center mb-8 gap-3">
            <a
              href="/"
              class="text-xs font-800 text-teal-600 uppercase tracking-widest flex items-center gap-2"
            >
              ← Back to istay
            </a>
          ...
          <div class="invoice-card bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden p-12 sm:p-16 relative">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start gap-8 mb-16 border-b border-gray-100 pb-12">
              ...
              <div class="sm:text-right">
                ...
                <p class="text-xs font-700 text-gray-400 uppercase tracking-widest mb-4">
                  CONFIRMED RESERVATION
                </p>
                <div class="space-y-1">
                  <p class="text-sm font-600 text-gray-500">
                    Invoice:{" "}
                    <span class="text-gray-900 font-700">{invoiceNumber}</span>
                  </p>
                  <p class="text-sm font-600 text-gray-500">
                    Date:{" "}
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-12 mb-16">
              <div>
                <h3 class="text-xs font-800 text-gray-400 uppercase tracking-[0.2em] mb-4">
                  Billed To
                </h3>
                <p class="text-lg font-800 text-gray-900">
                  {booking.guestName}
                </p>
              ...
              <div class="sm:text-right">
                ...
                <p class="text-lg font-800 text-gray-900">
                  {property?.name || "istay Property"}
                </p>
                <p class="text-sm text-gray-500 mt-1 font-500">
                  {property?.address || "Location Details in Dashboard"}
                </p>
              </div>
            </div>
              ...
              <table class="w-full text-left mb-12">
                <thead>
                  <tr class="border-b-2 border-gray-900">
                    <th class="py-4 text-xs font-900 text-gray-900 uppercase tracking-widest">
                      Description
                    </th>
                    <th class="py-4 text-xs font-900 text-gray-900 uppercase tracking-widest">
                      Nights
                    </th>
                    <th class="py-4 text-xs font-900 text-gray-900 uppercase tracking-widest text-right">
                      Amount
                    </th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                  <tr>
                    ...
                    <td class="py-6 font-800 text-gray-900">
                      {booking.nights}
                    </td>
                    <td class="py-6 font-800 text-gray-900 text-right">
            ...
            <div class="flex justify-end p-8 bg-gray-50 rounded-3xl">
              <table class="w-full sm:w-72">
                ...
                <tr class="border-t border-gray-200">
                  <td class="py-4 font-900 text-teal-600 text-lg">
                    Total Payable
                  </td>
                  <td class="text-right py-4 font-900 text-teal-600 text-lg">
            ...
            <div class="mt-20 pt-10 border-t border-gray-100 text-center">
              <p class="text-xs text-gray-400 font-500 leading-relaxed">
                This is a system-generated tax invoice issued by istay on behalf
                of the host. <br />
