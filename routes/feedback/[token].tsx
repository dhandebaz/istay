...
export const handler: Handlers<FeedbackData> = {
  async GET(_req, ctx) {
    ...
    if (!survey) {
      return new Response("Invalid or expired feedback link.", { status: 404 });
    }
    ...
    return (
      <div class="min-h-screen bg-gray-50 flex items-center justify-center p-6 text-center">
        <div class="max-w-md w-full bg-white rounded-[2.5rem] p-12 shadow-xl border border-gray-100">
          <div class="w-20 h-20 rounded-3xl bg-teal-50 flex items-center justify-center text-3xl mx-auto mb-8 animate-bounce">
            ✨
          </div>
          <h1 class="text-3xl font-900 text-gray-900 mb-4 tracking-tight">
            Thank you!
          </h1>
          <p class="text-gray-500 font-500 leading-relaxed mb-8">
            Your feedback helps {property?.name || "the host"}{" "}
            stay amazing. We hope to see you again soon at istay.
          </p>
          <a
            href="/"
            class="inline-block px-8 py-3.5 bg-gray-900 text-white rounded-xl font-800 text-sm shadow-xl active:scale-95 transition-all"
          >
            Back to Home
          </a>
        </div>
      ...
      <div class="min-h-screen bg-white py-12 px-6">
        <main class="max-w-xl mx-auto">
          <div class="text-center mb-12">
            <h1 class="text-teal-600 font-900 text-3xl tracking-tighter mb-4">
              istay
            </h1>
            <p class="text-xs font-800 text-gray-400 uppercase tracking-widest mb-2">
              Post-Stay Survey
            </p>
            <h2 class="text-2xl font-800 text-gray-900 tracking-tight">
          ...
          <form method="POST" class="space-y-8">
            <div class="bg-gray-50 rounded-[2rem] p-10 border border-gray-100">
              <label class="block text-center text-sm font-700 text-gray-900 mb-8 uppercase tracking-widest">
                Your Rating
              </label>
            ...
            <div class="space-y-4">
              <label class="block text-sm font-800 text-gray-900 tracking-tight">
