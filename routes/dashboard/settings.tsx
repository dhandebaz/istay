      ...
      <div class="space-y-6 max-w-4xl">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="hidden sm:block">
            <span
              class={`px-3 py-1 rounded-full text-[10px] font-800 uppercase tracking-widest ${
                role === "owner"
        ...
        <SettingsTabs initialTab={activeTab} tabs={tabs}>
          <div class="mt-8 space-y-0">
            ...
            <div class={activeTab === "general" ? "block" : "hidden"}>
              <div class="max-w-2xl space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                  <h2 class="text-base font-700 text-gray-900 mb-3">
                    Subscription
                  </h2>
                  <div class="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-istay-50 to-istay-100 border border-istay-200">
                    <div>
                      <p class="text-sm font-700 text-istay-900">
                        Lifetime Plan
                      </p>
              ...
              <div class="max-w-2xl space-y-6">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
                  ...
                  <p class="text-xs text-gray-400">
                    Choose how you want to be notified about booking activity.
                  </p>

                  {[
                    {
                      id: "notif_email_booking",
                      label: "New Booking Confirmation",
                      desc: "Receive an email when a new booking is confirmed",
                      icon: "📩",
                    },
                    {
                      id: "notif_email_checkout",
                      label: "Check-out Reminder",
                      desc:
                        "Get notified when a guest's check-out date is approaching",
                      icon: "📅",
                    },
                    {
                      id: "notif_whatsapp_room",
                      label: "Room Ready (WhatsApp)",
                      desc: "WhatsApp alert when caretaker marks room as clean",
                      icon: "💬",
                    },
                    {
                      id: "notif_email_payout",
                      label: "Payout Settled",
                      desc: "Email confirmation when earnings are transferred",
                      icon: "💰",
                    },
                    {
                      id: "notif_whatsapp_verify",
                      label: "ID Verification (WhatsApp)",
                      desc: "Instant WhatsApp when guest identity is verified",
                      icon: "🆔",
                    },
                  ].map((pref) => (
                    <div
                      key={pref.id}
                      class="flex items-start justify-between p-4 rounded-xl bg-gray-50 border border-gray-100"
                    >
                      ...
                      <label class="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                        ...
                        <div class="w-9 h-5 bg-gray-200 peer-focus:ring-2 peer-focus:ring-istay-500/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-istay-600 after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all">
                        </div>
                      </label>
                    </div>
                  ))}
            ...
            <div class={activeTab === "billing" ? "block" : "hidden"}>
              <div class="max-w-2xl space-y-6">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                  <h2 class="text-base font-700 text-gray-900 mb-4">
                    Billing Overview
                  </h2>

                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div class="p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200">
                      <p class="text-[10px] font-800 text-emerald-600 uppercase tracking-widest mb-1">
                        Commission Model
                      </p>
                    ...
                    <div class="p-4 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200">
                      <p class="text-[10px] font-800 text-gray-500 uppercase tracking-widest mb-1">
                        Monthly Fees
                      </p>
                      <p class="text-xl font-900 text-gray-800">₹0</p>
                      <p class="text-xs text-gray-500 mt-0.5">
                        Lifetime plan — zero overhead
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="p-4 rounded-xl bg-istay-50 border border-istay-200 flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs text-istay-700 mt-0.5">
                        One-time ₹1,000 activation
                      </p>
                    </div>
                    <span
                      class={`px-3 py-1 rounded-full text-xs font-800 ${
                        host?.setupFeePaid
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                  ...
                  <p class="text-xs text-gray-400 mb-4">
                    Payouts are processed automatically to your registered bank
                    account via Cashfree.
                  </p>
                  ...
                  <div class="p-4 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                      <p class="text-sm font-700 text-gray-900">
                        {host?.cashfreeVendorId
                          ? `Vendor: ${host.cashfreeVendorId}`
                          : "Not configured"}
                      </p>
                      <p class="text-xs text-gray-400 mt-0.5">
                        {host?.cashfreeVendorId
                          ? "Automatic payouts enabled"
                          : "Contact support@istay.space to set up payouts"}
                      </p>
                    </div>
                  </div>
                </div>
