      ...
      <div class="px-8 py-6 border-b border-gray-50 flex flex-col gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <div class="flex items-center gap-2">
            <label class="text-[10px] font-700 text-gray-400 uppercase tracking-widest shrink-0">From</label>
            <input
              type="date"
              value={dateFrom}
          ...
          <div class="flex items-center gap-2">
            <label class="text-[10px] font-700 text-gray-400 uppercase tracking-widest shrink-0">To</label>
            <input
              type="date"
              value={dateTo}
          ...
          <span class="text-[10px] text-gray-400 font-600 ml-auto">
            {filtered.length} entries{filtered.length !== entries.length ? ` of ${entries.length}` : ""}
          </span>
        </div>
      </div>
